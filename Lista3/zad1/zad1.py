...
from radix import radix_sort, radix_sort_stat
...
def initialize(params):
    ...
    elif params["type"] == "radix":
        radix_sort(params["comp"], params["n"], params["array"])
    
def initialize_stat(params):
    n = 10
    i = 1
    while n < 100001:
        for _ in range(0, params["k"]):
            random.seed()
            array = []
            for _ in range(0, n):
            ...
            if params["type"] == "merge":
                ...
                radix_sort_stat(params["comp"], n, array, params["filename"])
        if i > 0:
            n *= 5
        else:
            n *= 2
